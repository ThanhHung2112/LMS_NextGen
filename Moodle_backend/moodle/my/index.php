...
echo '<a style = "display: block; outline: none; border: 1px solid #333; padding: 10px 20px; background-color: white; 
         margin-bottom: 20px; text-decoration: none; text-align: center; color: #333; border-radius: 10px"
    href="http://localhost/local/message/edit.php">
    Test ML model
</a>';
