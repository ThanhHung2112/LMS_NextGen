...
class __Mustache_4fe5e04f8f5e6ddcee9a0913240ccbf4 extends Mustache_Template
{
...
';
        $value = $context->find('type_assign');
        $buffer .= $this->section7486409f4ee03966f2d7b5d846edc27b($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
    ...
    private function section90ca265600b6811b932cceff279bc737(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section7486409f4ee03966f2d7b5d846edc27b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section90ca265600b6811b932cceff279bc737($context, $indent, $value);
                $context->pop();
            }
        }
