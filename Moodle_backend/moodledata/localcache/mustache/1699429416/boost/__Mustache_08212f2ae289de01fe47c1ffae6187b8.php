...
class __Mustache_08212f2ae289de01fe47c1ffae6187b8 extends Mustache_Template
{
...
';
        $value = $context->find('type_assign');
        $buffer .= $this->section97f201b6a40b7aa9e0fe1ec615674749($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
    ...
    private function section2ac6752be1d71a702470d91b067323cd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <ul class="ml-english-grammar-check">
            <li>{{ tense }} (Number of errors: {{ frequency }})</li>
        </ul>
        ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
...
';
    ...
    private function sectionCdff9ca6e346b01eb2980f51b7181125(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
    <div class="ml-content ml-grading ml-content-assign ml-english">
        <h2 class="ml-assign-description-title ml-english-title">Tenses need improvement</h2>
        {{# tenses }}
        <ul class="ml-english-grammar-check">
            <li>{{ tense }} (Number of errors: {{ frequency }})</li>
        </ul>
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '    <div class="ml-content ml-grading ml-content-assign ml-english">
';
                $buffer .= $indent . '        <h2 class="ml-assign-description-title ml-english-title">Tenses need improvement</h2>
';
                $value = $context->find('tenses');
                $buffer .= $this->section2ac6752be1d71a702470d91b067323cd($context, $indent, $value);
                $buffer .= $indent . '    </div>
';
                $context->pop();
            }
    ...
    private function section5604853296e34e1ade3998a537b32fe2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionCdff9ca6e346b01eb2980f51b7181125($context, $indent, $value);
                $buffer .= $indent . '
';
                $buffer .= $indent . '
';
    ...
    private function section97f201b6a40b7aa9e0fe1ec615674749(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section5604853296e34e1ade3998a537b32fe2($context, $indent, $value);
                $context->pop();
            }
        }
