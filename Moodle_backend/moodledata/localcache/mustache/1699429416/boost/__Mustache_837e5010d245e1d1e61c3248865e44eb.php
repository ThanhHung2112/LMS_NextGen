...
class __Mustache_837e5010d245e1d1e61c3248865e44eb extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block7a09ed04dab7a20d49ec177fbb94aba8'),
            ));
...
';
    ...
    public function block7a09ed04dab7a20d49ec177fbb94aba8($context)
    {
        $indent = $buffer = '';
