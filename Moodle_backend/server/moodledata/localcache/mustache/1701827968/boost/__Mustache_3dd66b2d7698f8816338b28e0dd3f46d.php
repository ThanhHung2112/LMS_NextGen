...
class __Mustache_3dd66b2d7698f8816338b28e0dd3f46d extends Mustache_Template
{
...
';
            $buffer .= $indent . '            <button class="ml-button ml-button--vietnamese">Add New Assignment</button>
';
            $buffer .= $indent . '        </div>
';
            $buffer .= $indent . '    </div>
